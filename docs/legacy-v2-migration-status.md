...
|---|---|---|---|---|---|---|---|
| DECO-002 | カード重ねオフセット | DECO | 日立 | indexes/decorations.md、sites/002_hitachi/ | A | なし | 第2バッチ以降で移行 |
| DECO-003 | 見出しの型(英語ラベル+和文見出し+短下線) | DECO | 岩崎電気 | parts/DECO-003.json、parts/DECO-003.svg、sites/003_iwasaki/ | A | なし | 第1バッチで移行済み |
| DECO-004 | 固定ヘッダー(スクロール表示・言語トグル+検索併設) | DECO | 岩崎電気 | indexes/decorations.md、sites/003_iwasaki/ | A | なし | 第2バッチ以降で移行 |
...
| DECO-006 | フッター(濃色中央寄せ縦積み) | DECO | 福助 | indexes/decorations.md、sites/004_fukuske/ | A | なし | 第2バッチ以降で移行 |
| DECO-008 | 2カラム関連情報カード | DECO | Apple | indexes/decorations.md、sites/005_apple/ | A | なし | 第2バッチ以降で移行 |
| DECO-009 | ピル型セグメントタブ | DECO | Apple | indexes/decorations.md、sites/005_apple/ | A | なし | 第2バッチ以降で移行 |
| DECO-010 | スライダー型ヒーロー | DECO | 安川電機 | indexes/decorations.md、sites/006_yaskawa/ | A | なし | 第2バッチ以降で移行 |
...
| DECO-013 | 人物はみ出しメッセージカード | DECO | PROGRIT | indexes/decorations.md、sites/007_progrit/ | A | なし | 第2バッチ以降で移行 |
...
| DECO-023 | アイコン付き正方ダブルCTA | DECO | Ubie | indexes/decorations.md、sites/016_ubie/ | A | なし | 第2バッチ以降で移行 |
...
| LAYOUT-001 | フルブリードヒーロー(左コピー+斜め曲線リボン) | LAYOUT | 日新ネットワークス | indexes/layouts.md、sites/001_nisshin/ | A | なし | 第2バッチ以降で移行 |
| LAYOUT-002 | フルブリードヒーロー(コピー中央+左右矢印スライダー) | LAYOUT | 日立 | indexes/layouts.md、sites/002_hitachi/ | A | なし(Notion DB上の名称がLAYOUT-001と同一。内容は別のため移行時に要確認) | 第2バッチ以降で移行 |
| LAYOUT-003 | テキスト左・画像右セクション | LAYOUT | 岩崎電気 | indexes/layouts.md、sites/003_iwasaki/ | A | なし | 第2バッチ以降で移行 |
| LAYOUT-004 | 円形カードナビ+バナー(1セット) | LAYOUT | 福助 | indexes/layouts.md、sites/004_fukuske/ | A | なし | 第2バッチ以降で移行 |
...
| LAYOUT-006 | 角丸カード非対称グリッド | LAYOUT | Apple | indexes/layouts.md、sites/005_apple/ | A | なし | 第2バッチ以降で移行 |
| LAYOUT-007 | 情報密度の高い2段ヘッダー | LAYOUT | 安川電機 | indexes/layouts.md、sites/006_yaskawa/ | A | なし | 第2バッチ以降で移行 |
...
| LAYOUT-010 | ダーク中央CONTACT+大型フッター | LAYOUT | PROGRIT | indexes/layouts.md、sites/007_progrit/ | A | なし | 第2バッチ以降で移行 |
...
| LAYOUT-013 | コーポレートトップ全体構成(丸ごとテンプレ) | LAYOUT | 日本ゼトック | indexes/layouts.md、sites/012_zettoc/ | A | なし | 第2バッチ以降で移行 |
| LAYOUT-014 | 製造業トップ全体構成(丸ごとテンプレ) | LAYOUT | ノダRFテクノロジーズ | indexes/layouts.md、sites/013_nrf/ | A | なし | 第2バッチ以降で移行 |
| LAYOUT-015 | ダブルCTAブロック付き浮きヘッダ | LAYOUT | Golfcart Vision | indexes/layouts.md、sites/014_golfcart/ | A | なし | 第2バッチ以降で移行 |
